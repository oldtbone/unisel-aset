                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('room_booking_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.room-bookings.index') }}">
                                            {{ trans('cruds.roomBooking.title') }}
                                        </a>
                                    @endcan
                                    @can('room_booking_history_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.room-booking-histories.index') }}">
                                    ...
                                    @endcan
                                    @can('room_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.rooms.index') }}">
                                    ...
                                    @can('programme_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.programmes.index') }}">
                                    ...
                                    @can('room_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.room-types.index') }}">
                                            {{ trans('cruds.roomType.title') }}
                                        </a>
                                    @endcan
                                    @can('asset_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.asset-types.index') }}">
                                            {{ trans('cruds.assetType.title') }}
                                        </a>
                                    @endcan
                                    @can('asset_model_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.asset-models.index') }}">
