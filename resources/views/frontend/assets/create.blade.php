                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="asset_tag" id="asset_tag" value="{{ old('asset_tag', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date') }}" required>
