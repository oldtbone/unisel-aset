...
class AssetModelController extends Controller
{
    public function index()
    {
        ...
        return view('admin.assetModels.index', compact('assetModels'));
    }
    ...
    public function create()
    {
        ...
        $asset_types = AssetType::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.assetModels.create', compact('asset_types'));
    }
    ...
    public function store(StoreAssetModelRequest $request)
    {
        ...
        return redirect()->route('admin.asset-models.index');
    }
    ...
    public function edit(AssetModel $assetModel)
    {
        ...
        return view('admin.assetModels.edit', compact('asset_types', 'assetModel'));
    }
    ...
    public function show(AssetModel $assetModel)
    {
        ...
        return view('admin.assetModels.show', compact('assetModel'));
    }
