...
class RoomTypeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.roomTypes.index', compact('roomTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.roomTypes.create');
    }
    ...
    public function store(StoreRoomTypeRequest $request)
    {
        ...
        return redirect()->route('frontend.room-types.index');
    }
    ...
    public function edit(RoomType $roomType)
    {
        ...
        return view('frontend.roomTypes.edit', compact('roomType'));
    }
    ...
    public function show(RoomType $roomType)
    {
        ...
        return view('frontend.roomTypes.show', compact('roomType'));
    }
