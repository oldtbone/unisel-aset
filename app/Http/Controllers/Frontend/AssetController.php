...
class AssetController extends Controller
{
    ...
    public function create()
    {
        ...
        $asset_models = AssetModel::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        $room_attaches = Room::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
        ...
        return view('frontend.assets.create', compact('categories', 'asset_models', 'room_attaches', 'manufacturers', 'statuses', 'locations', 'assigned_tos'));
    }
    ...
    public function edit(Asset $asset)
    {
        ...
        return view('frontend.assets.edit', compact('categories', 'asset_models', 'room_attaches', 'manufacturers', 'statuses', 'locations', 'assigned_tos', 'asset'));
    }
